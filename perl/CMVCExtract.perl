...
my $commit_path_base = "D:\\composer8210_base";
...
#    system($cmd);
########2014/09/18  to ignore file whose name start with space: BTTTestSuit/InternetBankTestWeb/WebContent/js/scriptWidget_BC009/ scriptWidget_MinusSign.js

$fullpath=~s/\/\s+/\//g;


print("File -extract  $aPathName -family $family -release $release -version $aVersionSID -crlf -fmask 777 -relative $fullpath");    
  # if ($fullpath !=~m/scriptWidget_MinusSign/){
